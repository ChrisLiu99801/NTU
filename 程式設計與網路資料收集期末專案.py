...
col1, col2, col3 = st.columns(3)
col1.metric("投資組合報酬率", "{:.2%}".format(tickers_min_var_port[0]))
col2.metric("投資組合波動率", "{:.2%}".format(tickers_min_var_port[1]))
...
col6.metric("投資組合詹森指標", format(tickers_min_var_port[5], '.3f'))
st.divider()
